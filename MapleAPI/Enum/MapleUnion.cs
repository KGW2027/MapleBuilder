...
public class MapleUnion
{
    ...
    private static byte[][] UnionField = {
        ...
        new byte[]{18, 18, 18, 18, 18,  7,  8,  8,  8,  8,  8,  1,  1,  1,  1,  1,  2, 13, 13, 13, 13, 13},
        new byte[]{18, 18, 18, 18, 18,  7,  7,  8,  8,  8,  8,  1,  1,  1,  1,  2,  2, 13, 13, 13, 13, 13},
        new byte[]{18, 18, 18, 18, 18,  7,  7,  7,  8,  8,  8,  1,  1,  1,  2,  2,  2, 13, 13, 13, 13, 13},
        new byte[]{18, 18, 18, 18, 18,  7,  7,  7,  7,  8,  8,  1,  1,  2,  2,  2,  2, 13, 13, 13, 13, 13},
        new byte[]{18, 18, 18, 18, 18,  7,  7,  7,  7,  7,  8,  1,  2,  2,  2,  2,  2, 13, 13, 13, 13, 13},
        new byte[]{17, 17, 17, 17, 17,  6,  6,  6,  6,  6,  5,  4,  3,  3,  3,  3,  3, 14, 14, 14, 14, 14},
        new byte[]{17, 17, 17, 17, 17,  6,  6,  6,  6,  5,  5,  4,  4,  3,  3,  3,  3, 14, 14, 14, 14, 14},
        new byte[]{17, 17, 17, 17, 17,  6,  6,  6,  5,  5,  5,  4,  4,  4,  3,  3,  3, 14, 14, 14, 14, 14},
        new byte[]{17, 17, 17, 17, 17,  6,  6,  5,  5,  5,  5,  4,  4,  4,  4,  3,  3, 14, 14, 14, 14, 14},
        new byte[]{17, 17, 17, 17, 17,  6,  5,  5,  5,  5,  5,  4,  4,  4,  4,  4,  3, 14, 14, 14, 14, 14},
    ...
    public static ClaimType GetOptionBySlot(int x, int y)
    {
    ...
    public static MapleStatus.StatusType GetStatusTypeByClaimType(ClaimType claimType, List<MapleStatus.StatusType> innerTypes)
    {
        ...
        {
            ClaimType.INNER_0 => innerTypes[1],
            ClaimType.INNER_1 => innerTypes[2],
            ClaimType.INNER_2 => innerTypes[3],
            ClaimType.INNER_3 => innerTypes[4],
            ClaimType.INNER_4 => innerTypes[5],
            ClaimType.INNER_5 => innerTypes[6],
            ClaimType.INNER_6 => innerTypes[7],
            ClaimType.INNER_7 => innerTypes[0],
