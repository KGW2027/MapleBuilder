...
public class MapleSetBlackAccessory : ISetType
{
    public MapleEquipType.EquipType[] GetEquipmentTypesInSet()
    {
        return new[]
        {
            ...
            MapleEquipType.EquipType.HEART,
            ...
            MapleEquipType.EquipType.EMBLEM
        };
    }
